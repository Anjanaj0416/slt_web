...
interface Props {
  ...
  handleFetch: (address: POSTAddressResponse) => void;
  handleCloseModal: () => void;
}
// ================================================================

const EditAddressForm: FC<Props> = ({
  openModal,
  address,
  handleCloseModal,
  handleFetch,
  ...
  //
  const [updateAddress, { isLoading: isUpdating, isSuccess, data: updatedAddress }] =
    useUpdateAddressMutation();

  useEffect(() => {
    if (isSuccess && !isUpdating) {
      handleCloseModal();
      handleFetch(updatedAddress);
