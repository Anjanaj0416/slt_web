    ...
    <Fragment>
      <Card1 sx={{ mb: 4 }}>
        <FormControlLabel
          ...
          control={<Radio checked={paymentMethod === "credit-card"} color="primary" size="small" />}
        />
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item sm={6} xs={12}>
                      <TextField
                        ...
                        helperText={(touched.exp_date && errors.exp_date) as string}
                      />
                    </Grid>
                    <Grid item sm={6} xs={12}>
                      <TextField
        ...
        <FormControlLabel
          ...
          control={<Radio checked={paymentMethod === "paypal"} color="primary" size="small" />}
        />
        ...
        <FormControlLabel
          ...
          control={<Radio checked={paymentMethod === "cod"} color="primary" size="small" />}
        />
      </Card1>
