...
export const catgoryNavigation = [
  ...
  },
  {
    ...
    categoryItem: [
      ...
      { icon: "Flower", title: "Flower", href: "/products/search/Dariry & Eggs" },
      { icon: "TeddyBear", title: "Teddy Bears", href: "/products/search/Breakfast" },
      { icon: "ValentineGift", title: "Valentine Gifts", href: "/products/search/Frozen" },
      { icon: "WeddingGift", title: "Wedding Gifts", href: "/products/search/Organic" },
      { icon: "NewYearGift", title: "New Year Gift", href: "/products/search/Canned Food" },
      { icon: "Toys", title: "Toys", href: "/products/search/Coffee & Snacks" },
      { icon: "Football", title: "Ball", href: "/products/search/Sauces & Jems" },
      { icon: "BabyToys", title: "Baby Toys", href: "/products/search/Sauces & Jems" },
