...
export const catgoryNavigation = [
  {
    ...
    categoryItem: [
      { icon: "Home", title: "Home", href: "/product/search/Dariry & Eggs" },
      { icon: "Popular", title: "Popular Products", href: "/product/search/Breakfast" },
      { icon: "Trending", title: "Trending Products", href: "/product/search/Frozen" },
      { icon: "Products", title: "All Products", href: "/product/search/vegetables" },
    ],
  },
  {
    category: "Top Categories",
    categoryItem: [
      ...
      { icon: "Flower", title: "Flower", href: "/product/search/Dariry & Eggs" },
      { icon: "TeddyBear", title: "Teddy Bears", href: "/product/search/Breakfast" },
      { icon: "ValentineGift", title: "Valentine Gifts", href: "/product/search/Frozen" },
      { icon: "WeddingGift", title: "Wedding Gifts", href: "/product/search/Organic" },
      { icon: "NewYearGift", title: "New Year Gift", href: "/product/search/Canned Food" },
      { icon: "Toys", title: "Toys", href: "/product/search/Coffee & Snacks" },
      { icon: "Football", title: "Ball", href: "/product/search/Sauces & Jems" },
      { icon: "BabyToys", title: "Baby Toys", href: "/product/search/Sauces & Jems" },
      { icon: "Robot", title: "Robot", href: "/product/search/Sauces & Jems" },
    ],
  },
];
