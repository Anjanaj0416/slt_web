...
export const categoryNavigation = [
  ...
  { icon: "Thermometer", title: "Digital Thermometer", href: "/product/search/Sauces & Jems" },
  { icon: "OxygenPump", title: "Oxygen Pump", href: "/product/search/Breakfast" },
  { icon: "LenseCase", title: "Lense Case Kit", href: "/product/search/Frozen" },
  { icon: "AutoMotive", title: "Automotive", href: "/product/search/Organic" },
];
