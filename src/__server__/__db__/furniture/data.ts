...
export const categoryNavigation = [
  ...
  },
  {
    ...
    categoryItem: [
      ...
      { icon: "Living", title: "Living", href: "/product/search/Coffee & Snacks" },
      { icon: "RoundTable", title: "Coffee Tea Table", href: "/product/search/Coffee & Snacks" },
      { icon: "RoomSet", title: "Living Room Sets", href: "/product/search/Coffee & Snacks" },
    ],
  },
];
