...
const navigations = [
  {
    ...
    menuData: {
      ...
      rightImage: { imgUrl: "/assets/images/promotion/offer-1.png", href: "/sale-page-1" },
    },
  },
  {
    icon: Laptop,
  ...
  },
  {
    ...
    menuData: [
      ...
      { icon: Woman, title: "Woman", href: "/product/search/electronics", megaMenu: 2 },
      { icon: BabyBoy, title: "Baby Boy", href: "/product/search/home&garden", megaMenu: 3 },
      { icon: BabyGirl, title: "Baby Girl", href: "/product/search/bikes", megaMenu: "MegaMenu1" },
    ],
  },
  {
    icon: PlantPot,
  ...
  },
  {
    ...
    menuData: [
      ...
      { icon: Laptop, title: "Electronics", href: "/product/search/electronics" },
      { icon: PlantPot, title: "Home & Garden", href: "/product/search/home&garden" },
      ...
      { icon: MakeUp, title: "Health & Beauty", href: "/product/search/health&beauty" },
      { icon: Pets, title: "Pets", href: "/product/search/pets" },
      { icon: TeddyBear, title: "Baby Toys", href: "/product/search/baby-toys" },
